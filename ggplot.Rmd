...
Some of the contents of this document have been adapted from @wilke2019fundamentals.[Take a look](https://serialmentor.com/dataviz/) at the online version of the booko for further insights.
...
![](resources/images/amounts-1.png)
...
![](resources/images/amounts_multi-1.png)
## Distributions
...
![](resources/images/single-distributions-1.png)
...
![](resources/images/multiple-distributions-1.png)
...
![](resources/images/proportions-1.png)
...
![](resources/images/proportions-comp-1.png)
...
![](resources/images/basic-scatter-1.png)
...
![](resources/images/xy-binning-1.png)
...
![](resources/images/errorbars-1.png)
...
Take a loof at the [reference guide](https://ggplot2.tidyverse.org/reference/) from the tidyverse site, visit the [sthda website](http://www.sthda.com/english/wiki/ggplot2-essentials) or check `ggplot2`'s cheatsheet:
![](resources/images/ggplot_cheatsheet.png)

## Pipelines and `ggplot2`

Since `ggplot2` it's a member of tidyverse it was design to be operable from `dplyr`s pipelines. That means we can use any number of verbs to manipulate a data frame and then pass it to `ggplot()` using `%>%`. After that we keep using the regular `+` operator to concatenate plot instructions:
